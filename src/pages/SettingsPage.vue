      ...
      <div class="border-t border-border-default pt-3">
        ...
        <div v-if="showSetupGuide" class="mt-3 space-y-2 text-xs text-text-secondary">
          ...
          <ol class="list-decimal list-inside space-y-2 ml-1">
            <li>
              Go to
              <a href="https://console.cloud.google.com/" target="_blank" rel="noopener" class="text-accent hover:underline">Google Cloud Console</a>
              and create a new project (or select an existing one)
            </li>
            <li>
              Enable the
              <a href="https://console.cloud.google.com/apis/library/calendar-json.googleapis.com" target="_blank" rel="noopener" class="text-accent hover:underline">Google Calendar API</a>
            </li>
            <li>
              Enable the
              <a href="https://console.cloud.google.com/apis/library/gmail.googleapis.com" target="_blank" rel="noopener" class="text-accent hover:underline">Gmail API</a>
            </li>
            <li>
              Go to
              <a href="https://console.cloud.google.com/apis/credentials/consent" target="_blank" rel="noopener" class="text-accent hover:underline">OAuth consent screen</a>,
              set up as <strong>External</strong>, and add your email as a <strong>test user</strong>
            </li>
            <li>
              Go to
              <a href="https://console.cloud.google.com/apis/credentials" target="_blank" rel="noopener" class="text-accent hover:underline">Credentials</a>,
              click <strong>+ Create Credentials</strong> &rarr; <strong>OAuth 2.0 Client ID</strong>
            </li>
            <li>
            ...
            <li>
              ...
              <code class="bg-surface rounded px-1.5 py-0.5 text-[11px] font-mono text-text-primary">http://localhost:5173</code>
            </li>
            <li>
              Add <strong>Authorized redirect URIs</strong>:
              <code class="bg-surface rounded px-1.5 py-0.5 text-[11px] font-mono text-text-primary">http://localhost:5173/auth/google/callback</code>
            </li>
            <li>
              Copy the <strong>Client ID</strong> and paste it in the field above, then click Save
            </li>
          ...
          <div class="mt-3 rounded-lg bg-surface-overlay p-3 text-[11px]">
            ...
            <p>Google will show a warning screen because your app is in testing mode. This is normal. Click <strong>Advanced</strong> &rarr; <strong>Go to [your project name] (unsafe)</strong> to proceed. Only your test user accounts can sign in.</p>
          </div>
        </div>
      </div>
    </div>
