...
**Standard** (pour fonds sombres) :

![Built with LLMxRay](https://raw.githubusercontent.com/LogneBudo/llmxray/master/badges/built-with-llmxray.svg)

**Sombre** (pour fonds clairs) :

![Built with LLMxRay](https://raw.githubusercontent.com/LogneBudo/llmxray/master/badges/built-with-llmxray-dark.svg)
